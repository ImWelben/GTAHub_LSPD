                ...
                embeds: [
                    new Discord.EmbedBuilder()
                        ...
                        .addFields([
                            ...
                            {name: `¿Quieres crear una sugerencia?`, value: `Envía la descripción de la sugerencia por este canal y el bot hará su trabajo.\n*PD: Las imagenes se insertan por* ***link***. *No se insertan, sino no se verán.*`, inline: false},
                        ])
                        .setThumbnail('https://imgur.com/hJJpZo7.png')
                        .setImage(`https://imgur.com/Oe7fUg3.png`)
                        .setColor("#064073")
